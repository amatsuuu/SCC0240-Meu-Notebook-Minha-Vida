...
CREATE TABLE DISPOSITIVO(
    ...
    CONSTRAINT CK_STATUS CHECK(UPPER(STATUS) IN ('Emprestado', 'Em manutenção', 'Disponível', 'Extraviado' ou 'Fora de serviço'))
...
CREATE TABLE TRANSACAO(
    ...
    DATA DATE NOT NULL,
    CONTA_DESTIDO NUMBER(12) NOT NULL,
    ...
    CONSTRAINT FK_TRANSACAO_COODENADOR FOREIGN KEY (COORDENADOR) REFERENCES COORDENADOR(CPF) ON DELETE CASCADE,
    CONSTRAINT FK_TRANSACAO_EMPRESA PRIMARY KEY (EMPRESA) REFERENCES EMPRESA(CNPJ) ON DELETE CASCADE,
...
CREATE TABLE EMPRESTIMO (
    DISPOSITIVO VARCHAR(12) NOT NULL,
    ALUNO CHAR(14) NOT NULL,
    DATA DATE NOT NULL,
    DATA_DEVOLUCAO NOT NULL,
    CONSTRAINT PK_EMPRESTIMO PRIMARY KEY (DISPOSITIVO, ALUNO, DATA),
    CONSTRAINT FK_EMPRESTIMO_DISPOSITIVO FOREIGNT KEY (DISPOSITIVO) REFERENCES DISPOSITIVO(NUMERO_SERIAL) ON DELETE CASCADE,
    CONSTRAINT FK_EMPRESTIMO_ALUNO FOREIGN KEY (ALUNO) REFERENCES ALUNO(CPF) ON DELETE CASCADE,
    CONSTRAINT CK_DATA CHECK(DATA_DEVOLUCAO > DATA)
);
...
CREATE TABLE MANUTENCAO(
    ...
    CONSTRAINT PK_MANUTENCAO PRIMARY KEY (DATA, DIPOSITIVO),
    CONSTRAINT FK_MANUTENCAO_DISPOSITIVO (DISPOSITIVO) REFERENCES DISPOSITIVO(NUMERO_SERIAL) ON DELETE CASCADE,
);
...
CREATE TABLE CURSO(
    ...
    CONSTRAINT FK_CURSO_COORDENADOR FOREIGN KEY (COORDENADOR) REFERENCES COORDENADOR(CPF) ON DELETE CASCADE,

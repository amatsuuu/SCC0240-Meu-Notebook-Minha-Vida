...
INSERT INTO ALUNO (CPF, REG_ALUNO, ANO_ESCOLAR, GRAU_ENSINO, NOME, DATA_NASC, RUA, NUMERO, CEP, TURMA_ATUAL, ESCOLA)
    VALUES ('444.555.666-78', '19178851262395', 3, 'M', 'LUCAS SANTOS', TO_DATE('2008-06-10', 'YYYY-MM-DD'), 'PRAÇA CENTRAL', 987, '44444-555', 1, 01978235);

INSERT INTO ALUNO (CPF, REG_ALUNO, ANO_ESCOLAR, GRAU_ENSINO, NOME, DATA_NASC, RUA, NUMERO, CEP, TURMA_ATUAL, ESCOLA)
    VALUES ('589.580.129-31', '19622481124238', 1, 'M', 'JORGE MATOS', TO_DATE('2008-10-01', 'YYYY-MM-DD'), 'RUA DAS ROSAS', 22, '51241-382', 2, 51234154);

INSERT INTO ALUNO (CPF, REG_ALUNO, ANO_ESCOLAR, GRAU_ENSINO, NOME, DATA_NASC, RUA, NUMERO, CEP, TURMA_ATUAL, ESCOLA)
    VALUES ('515.632.197-02', '19178851212395', 2, 'M', 'CARLOS PEDREIRA', TO_DATE('2009-07-29', 'YYYY-MM-DD'), 'AVENIDA PAULISTA', 1018, '12363-092', 10, 01978235);

INSERT INTO ALUNO (CPF, REG_ALUNO, ANO_ESCOLAR, GRAU_ENSINO, NOME, DATA_NASC, RUA, NUMERO, CEP, TURMA_ATUAL, ESCOLA)
    VALUES ('091.152.609-28', '75912768072414', 9, 'F', 'JULIA AKEMI', TO_DATE('2009-01-23', 'YYYY-MM-DD'), 'AVENIDA JABAQUARA', 1029, '13212-897', 10, 10293512);

INSERT INTO ALUNO (CPF, REG_ALUNO, ANO_ESCOLAR, GRAU_ENSINO, NOME, DATA_NASC, RUA, NUMERO, CEP, TURMA_ATUAL, ESCOLA)
    VALUES ('190.233.105-12', '65178932134180', 2, 'M', 'MARCIA SOUZA', TO_DATE('2009-06-01', 'YYYY-MM-DD'), 'AVENIDA BRASIL', 183, '01975-129', 1, 10293512);
...
INSERT INTO ALUNO (CPF, REG_ALUNO, ANO_ESCOLAR, GRAU_ENSINO, NOME, DATA_NASC, RUA, NUMERO, CEP, TURMA_ATUAL, ESCOLA)
    VALUES ('192.357.432-43', '78120389750124', 9, 'F', 'JULIO RODRIGUES', TO_DATE('2010-01-02', 'YYYY-MM-DD'), 'AVENIDA PRESIDENTE VARGAS', 217, '13212-897', 7, 10293512);

INSERT INTO ALUNO (CPF, REG_ALUNO, ANO_ESCOLAR, GRAU_ENSINO, NOME, DATA_NASC, RUA, NUMERO, CEP, TURMA_ATUAL, ESCOLA)
    VALUES ('032.436.646-41', '01238748912749', 4, 'F', 'RENAN CARVALHO', TO_DATE('2012-05-19', 'YYYY-MM-DD'), 'AVENIDA JABAQUARA', 131, '13212-897', NULL, 01978235);
